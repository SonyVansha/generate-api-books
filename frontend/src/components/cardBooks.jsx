  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div className="h-80 w-full">
        <a href="#">
          <img className="mx-auto h-full w-auto object-cover dark:hidden" src={book.coverImage} alt={book.title} />
          <img className="mx-auto hidden h-full w-auto object-cover dark:block" src={book.coverImage} alt={book.title} />
        </a>
      </div>
      ...
      <div className="pt-6">
        ...
        <div className="mb-4 flex items-center justify-between gap-4">
          <span className="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">{book.genre}</span>
        </div>

        {/* Name Books */}
        <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{book.title}</a>
        ...
        <ul className="mt-2 flex items-center gap-4">
          <li className="flex items-center gap-2">
            ...
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">{book.publishedDate}</p>
          </li>
          <li className="flex items-center gap-2">
            <svg className="h-4 w-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7h6l2 4m-8-4v8m0-8V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v9h2m8 0H9m4 0h2m4 0h2v-4m0 0h-5m3.5 5.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm-10 0a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" />
            </svg>
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">{book.username}</p>
          </li>
        </ul>
